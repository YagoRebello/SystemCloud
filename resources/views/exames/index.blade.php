@extends("layouts.default", ['title' => 'Exames'])
@section('content')
    @if (session('status'))
        <x-alert-default/>
    @endif
    ...
    <div class="panel-heading row">
        ...
        <div class="col-4">
            <ul class="links">
                <li><a href="{{ route('Exames.create') }}"><i class="bi bi-plus-square"></i> Adicionar</a></li>
            </ul>
        </div>
    </div>
        ...
        <form method="GET">
            <div class="form-group row">
                ...
                <div class="col-8 mt-3 center">
                    <div class="col">
                        <a class="btn btn-surface btn-sm right" href="{{ route('Exames.index') }}"><i class="bi bi-eraser-fill"></i> Limpar</a>
                    </div>
                    <div class="col">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex flex-row align-items-center">
                            <div class="ms-3 c-details">
                                <h6>Código: {{ $e->codigo }}</h6>
                                <hr style="color: black">
                                <h6>Descrição: {{ $e->descricao }}</h6>
                            </div>
                        </div>
                        <div class="badge">
                            <a class="btn btn-primary btn-sm" href="{{ route('Exames.edit', $e->id) }}"><i class="bi bi-pencil" style="color: white"></i> Editar</a>
                        </div>
                    </div>
